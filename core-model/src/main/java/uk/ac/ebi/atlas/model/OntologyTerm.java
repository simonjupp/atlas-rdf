...
import uk.ac.ebi.atlas.model.utils.StringUtil;
...
public abstract class OntologyTerm {
    ...
    public static OntologyTerm createFromURI(String uri) {
        return uri.contains("/") ? create(StringUtil.splitAtLastSlash(uri)[1], "", StringUtil.splitAtLastSlash(uri)[0]) : create(uri);
    }
