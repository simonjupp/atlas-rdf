...
public class SpeciesFactory {
    ...
    public Species create(AtlasExperimentDTO experimentDTO, BaselineExperimentConfiguration factorsConfig){
    ...
    public Species create(AtlasExperimentDTO experimentDTO){
