...
import uk.ac.ebi.spot.rdf.model.baseline.BaselineExperimentBuilder;
import uk.ac.ebi.spot.rdf.model.baseline.BaselineExperimentConfiguration;
import uk.ac.ebi.spot.rdf.model.baseline.ExperimentalFactorsFactory;
...
public abstract class BaselineExperimentsCacheLoader extends ExperimentsCacheLoader<BaselineExperiment> {
    ...
    protected BaselineExperimentsCacheLoader(
            ExperimentType experimentType, BaselineExperimentExpressionLevelFile expressionLevelFile,
    ...
    BaselineExperimentsCacheLoader(
            ExperimentalFactorsFactory experimentalFactorsFactory, ExperimentType experimentType,
    ...
    @Override
    public BaselineExperiment load(AtlasExperimentDTO experimentDTO, String experimentDescription,
